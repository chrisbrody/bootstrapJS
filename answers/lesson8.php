    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-4 col-md-6 col-md-offset-3">
          ...
          <button class="btn btn-success btn-block btn-alert">Alert Button</button>     
        ...
        <div class="col-sm-4 col-md-8">
            ...
            <button class="btn btn-warning btn-lg btn-alert">Click Here to Alert Us</button>
        ...
        <div class="col-sm-4 col-md-12">
          ...
          <button class="btn btn-danger btn-sm btn-alert">DONT CLICK THIS</button>
