    ...
    <div class="task">
      <div class="task1">
        <div class="col-md-12">
          ...
          <p class="lead">Create a Folder called BootstrapJS, add an index.html with the necessary starting html for any HTML doc, and a main.js file &amp; include it with a script tag - your main.js always goes as the last script before the closing body tag. Last, add the cdns to indluce Bootstrap CSS, jQuery &amp; Bootstrap JS from lesson 1</p>
          <ol>
            <li>Start on the index.html, create a <code>div</code> tag, with a class of <code>container</code> or <code>container-fluid</code>. Inside this, add a <code>row</code> div, and 2 more divs inside our <code>row</code>.</li>
