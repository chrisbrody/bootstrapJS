<div class="tab-pane" id="tab3">
  <article class="lesson3">
    ...
    <!-- dropdowns -->
    <div id="#" class="#">
      <h2>Dropdowns<small>.js</small></h2>
      <hr>
    ...
    <div class="task">
      <div class="task1">
        <div class="col-md-12">
          ...
          <div class="next1">
            <a href="#tab4" data-toggle="tab" class="btn btn-code btn-lg tabs"><i class="fa fa-child fa-2x"></i> Next Up: Using Bootstrap Scrollspy <i class="fa fa-2x fa-child"></i></a>
          </div>
        </div>
      </div>
      <div class="clearfix"></div>
      <div class="col-md-12">
        <a class="btn btn-danger btn-lg btn-task btn-block"><i class="fa fa-terminal"></i> Complete The Bootstrap <Strong>Dropdown</Strong> Task Before Moving On!</a>
      </div>
    </div>
