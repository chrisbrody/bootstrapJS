    ...
    <div class="task">
      <div class="task1">
        <div class="col-md-12">
          ...
          <div class="next1">
            <a href="#tab6" data-toggle="tab" class="btn btn-code btn-lg tabs"><i class="fa fa-child fa-2x"></i> Next Up: Easy Bootstrap Tooltips! <i class="fa fa-2x fa-child"></i></a>
          </div>
        </div>
      </div>
      <div class="clearfix"></div>
      <div class="col-md-12">
        <a class="btn btn-lg btn-task btn-block"><i class="fa fa-terminal"></i> Complete The Bootstrap <Strong>Tabs</Strong> Task Before Moving On!</a>
      </div>
    </div>
